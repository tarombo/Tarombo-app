...
This document provides a working reference for Batak Toba kinship terminology (*partuturan*) and the algorithms used to detect these relationships in Tarombo. It serves as both a cultural preservation document and a technical specification for the relationship detection system.

**Primary academic reference used for this spec:** K. Brineman Bovill, “Toba Batak relationship terminology”, *Bijdragen tot de Taal-, Land- en Volkenkunde* 141 (1985) 36–66 (`https://www.researchgate.net/publication/41017823_Toba_Batak_relationship_terminology/link/0e608114f0c46d4f0acb6805/download?_tp=eyJjb250ZXh0Ijp7ImZpcnN0UGFnZSI6InB1YmxpY2F0aW9uIiwicGFnZSI6InB1YmxpY2F0aW9uIn19`).
...
| --------------- | ------------------------------------------- | -------- | ----------------------------------------------------------------------- |
| **Tulang**    | Mother's brother                          | Male   | Ultimate authority figure in the maternal line                        |
| **Nantulang** | Mother's brother's wife                   | Female | Respected elder woman in the maternal line                            |
...
| **Tunggane*** | Wife’s brother (male ego reference term) | Male   | Male wife-giver in ego’s generation; reciprocal of**Lae** (male ego) |
...
*Note: In Bovill (1985), **Tunggane** and **Lae** are male-speaker reference terms. Women use different reference terms (e.g., **Eda**) and may require term-of-address logic; the app currently prioritizes reference-term labeling.*
...
| **Inanguda**    | Mother's sister                                          | Female | Beloved aunt, mother-like figure                                                    |
| **Angkang**     | Older same-sex sibling (male ego term)                   | Any    | Elder sibling term (usage varies by region; often paired with**Anggi**)             |
| **Haha**        | Older brother                                            | Male   | Respected elder sibling                                                             |
| **Anggi**       | Younger sibling                                          | Any    | Protected younger family member                                                     |
| **Iboto**       | Opposite-sex sibling; prohibited cross-cousin categories | Any    | “Sibling” classification used to mark marriage-prohibited relations (Bovill 1985) |
...
| **Maen**      | Daughter-in-law (broader category in Bovill 1985) | Female | Related concept;**Parumaen** is narrower in Bovill (1985)                |
...
| **Inang Bao** | Wife’s brother’s wife (male ego)                | Female | Wife-givers-of-wife-givers; reciprocal address uses**Bao**               |
| **Amang Bao** | Husband’s sister’s husband (female ego)         | Male   | Wife-givers-of-wife-givers; reciprocal address uses**Bao**               |
| **Paraman**   | Brother’s son (female ego)                       | Male   | “Like a father”; also appears as**Amang na Poso** in Bovill (1985)     |
| **Simatua**   | Parent-in-law (wife’s/husband’s parent)         | Any    | Respectful term for parents-in-law (optionally marked by**amang/inang**) |
...
6. **Tulang Rorobot** - Wife’s Mother’s Brother (Affinal Tulang)

   - **Pattern (Bovill 1985)**: A → Spouse → Spouse’s Mother → Spouse’s Mother’s Brother
   - **Example**: Person → Wife → Wife’s Mother → Wife’s Mother’s Brother
   - **Classification**: Hula-hula (affinal)
   - **Cultural Significance**: “Wife’s Tulang”; marked with *rorobot* due to distance/ceremonial framing
   - **Implementation Note**: This term should be detected from the actual affinal path; it should not be derived from generational distance alone.
...
### Speaker-Gender Rules (Bovill 1985)

These rules affect what term is returned for the *same genealogical position* depending on whether ego is male or female:

- **Prescribed marriage**: male ego → **MBD** is **Pariban**; female ego → **FZS** is **Pariban**
- **Prohibited marriage**: male ego → **FZD** is **Iboto**; female ego → **MBS** is **Iboto**

### Generation Modifiers (Bovill 1985)

- **Na Mulak / Mangulahi**: term applied to an alternate generation (e.g., `Pariban Na Mulak`, `Iboto Na Mulak`).
- **Na Poso**: term applied to a generation below its focus (e.g., `Tulang Na Poso`, `Nantulang Na Poso`).
- **-Tua / -Uda**: older/younger variants for **Amang**/**Inang** within their categories.

### Address vs Reference Mode

- **Reference mode** (default): returns canonical reference terms (e.g., **Ama Suhut**, **Ina Pangintubu**).
- **Address mode**: swaps to address forms where Bovill (1985) indicates usage (e.g., **Amang**, **Inang**, **Maen**, **Ito**).

### Marriage-Order Heuristic

- When enabled, **Pariban** age qualifiers (Angkang/Anggi) prioritize marriage date order (earlier marriage → Angkang).
- Falls back to birth date order if marriage dates are unavailable.
...
- **Tunggane** (male ego): Wife’s brother (male wife-giver in ego’s generation)
- **Simatua**: Parents-in-law (wife’s/husband’s parents)
- **Lae** (male ego): Wife’s sister (and also “sister’s husband” in many app use-cases)
...
- **Primary Academic Source**: Bovill (1985) (`https://www.researchgate.net/publication/41017823_Toba_Batak_relationship_terminology/fulltext/0e608114f0c46d4f0acb6805/Toba-Batak-relationship-terminology.pdf`)
- **Traditional Sources**: Partuturan / local usage notes (where available)
- **Cross-reference**: Compare term scope (reference vs address), speaker gender, and affinal directionality
...
| `[spouse, parent]`           | Simatua        | Hula-hula             | Affinal       |
| `[spouse, brother]`          | Tunggane*      | Hula-hula             | Affinal       |
| `[spouse, sister]`           | Lae*           | Hula-hula             | Affinal       |
| `[spouse, brother, spouse]`  | Inang Bao*     | Hula-hula             | Affinal       |
| `[spouse, sister, spouse]`   | Amang Bao*     | Hula-hula             | Affinal       |
| `[spouse, mother, brother]`  | Tulang Rorobot | Hula-hula             | Affinal       |
...
def get_batak_term(ego, target, genealogy_api):
    ...
    if signature == ["mother", "brother"]:
        ...
        return "Hela"
	        ...
	        return "Nantulang"
	    elif signature == ["spouse", "parent"]:
	        return "Simatua"
	    elif signature == ["spouse", "brother"]:
	        return "Tunggane"  # male ego reference term (Bovill 1985)
	    elif signature == ["spouse", "sister"]:
	        return "Lae"  # male ego reference term (Bovill 1985)
	    elif signature == ["spouse", "mother", "brother"]:
...
<string name="rel_batak_mothers_brother_wife">Nantulang</string>
<string name="rel_batak_mothers_brother_son">Lae</string>
<string name="rel_batak_mothers_brother_daughter">Pariban</string>
<string name="rel_batak_mothers_sister">Inanguda</string>
<string name="rel_batak_tunggane">Tunggane</string>
<string name="rel_batak_parent_in_law">Simatua</string>
<string name="rel_batak_father_in_law">Amang Simatua</string>
<string name="rel_batak_mother_in_law">Inang Simatua</string>
<string name="rel_batak_tulang_rorobot">Tulang Rorobot</string>
<string name="rel_batak_nantulang_rorobot">Nantulang Rorobot</string>

<!-- Dongan Tubu (Same clan) relationships -->
<string name="rel_batak_fathers_brother">Amanguda</string>
<string name="rel_batak_fathers_brother_wife">Inanguda</string>
<string name="rel_batak_older_brother">Haha</string>
...
<string name="rel_batak_fathers_sister_husband">Amangboru</string>
<string name="rel_batak_clan_sister">Ito</string>

<!-- Affinal relationships -->
<string name="rel_batak_son_wife">Parumaen</string>
<string name="rel_batak_daughters_husband">Hela</string>
<string name="rel_batak_brother_wife">Eda</string>
<string name="rel_batak_sister_husband">Lae</string>
<string name="rel_batak_co_parent_in_law">Bao</string>

<!-- Direct family -->
<string name="rel_batak_father">Ama</string>
<string name="rel_batak_mother">Ina</string>
<string name="rel_batak_child">Anak</string>
<string name="rel_batak_grandparent_paternal">Ompu</string>
